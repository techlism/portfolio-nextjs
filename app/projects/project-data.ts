...
export const projects: ProjectData[] = [
  {
    title : "TrackJobs",
    description : "TrackJobs is a job tracking app alongside a Google Chrome Extension that allows users to keep track of their job applications. It provides a personalized dashboard to manage job applications, interviews, and offers. TrackJobs is built with Next.js, Tailwind, SQLite and TypeScript (Of course).",
    deployed : "https://trackjobs.online",
  ...
  {
      title: "ConvertFast",
      description: "ConvertFast is an all-in-one media conversion tool made using Next.js and Web Assembly. It performs all processing client-side without involving any server. ConvertFast supports various media types and formats, providing a seamless and efficient conversion experience.",
