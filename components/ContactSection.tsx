...
export default function ContactSection(){
    return(
        <div className="bg-active-50 dark:bg-transparent mt-10 border rounded-lg p-2 shadow-[-2px_-2px_2px_2px_rgba(0,0,0,0.1),_2px_2px_2px_2px_rgba(45,78,255,0.15)] flex flex-col" id="contact">                
            <h1 className="mt-6 ml-5 mb-2 text-5xl font-bold text-active-500">
                Get in Touch
            </h1>
            <Separator className="my-4 mx-auto w-[99%] bg-active-950"/>         

            <div className="flex space-x-5 custom-font-color justify-center auto-gradient max-w-fit mx-auto p-4 rounded-md text-active-100">
