...
const ProjectsSection: React.FC = () => {  
    return (
      <div className="bg-active-50 dark:bg-transparent mt-10 border  rounded-lg p-2 pb-3 shadow-[-2px_-2px_2px_2px_rgba(0,0,0,0.1),_2px_2px_2px_2px_rgba(45,78,255,0.15)]" id="projects">
